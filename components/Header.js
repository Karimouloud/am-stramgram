        ...
        <div className="flex justify-between max-w-6xl mx-5 lg:mx-auto">
          ...
          <div className="max-w-xs" >
            <div className="relative mt-1 p-3 rounded-md" >
              ...
              <input className="bg-gray-50 block full pl-10 sm:text-sm border-gray-300 focus:ring-black focus:border-black rounded-md" type="text" placeholder="Rechercher"/>
            </div>
          </div>
          ...
          <div className="flex items-center justify-end space-x-4">
            ...
            {session ? (
              <>
                ...
                <button onClick={signIn}>S'enregistrer</button>
              )}           
